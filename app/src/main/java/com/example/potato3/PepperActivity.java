...
import com.example.potato3.ml.Pepper;
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (position < mArrayUri.size() - 1) {
                    ...
                    Toast.makeText(PepperActivity.this, "Last Image Already Shown!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        previousButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (position > 0) {
                    ...
                    Toast.makeText(PepperActivity.this, "This is the First Image!", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        clear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mArrayUri.size() > 0) {
                    ...
                    Toast.makeText(PepperActivity.this, "No images to clear!", Toast.LENGTH_SHORT).show();
                }
            }
        });
...
// ...
    ...
    public String classifyImage(Bitmap image){
        String output="";
        try {
            Pepper model = Pepper.newInstance(getApplicationContext());
            ...
            Pepper.Outputs outputs = model.process(inputFeature0);
            ...
            String[] classes = {"Bacterial Spot", "Healthy"};
